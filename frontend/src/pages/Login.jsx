              ...
              <div className="relative p-6 sm:p-8 lg:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative flex items-center gap-3">
                    <div className="h-px flex-1 bg-[#e2e8f0] dark:bg-[#273246]" />
                    <span className="text-xs text-[#94a3b8] dark:text-[rgba(255,255,255,0.35)]">o</span>
                    <div className="h-px flex-1 bg-[#e2e8f0] dark:bg-[#273246]" />
                  </div>

                  <a
                    href={`${import.meta.env.VITE_API_URL ?? 'http://localhost:3000/api'}/auth/google`}
                    className="flex h-14 w-full items-center justify-center gap-3 rounded-2xl border border-[#e2e8f0] bg-white/70 px-4 text-sm font-medium text-[#223354] shadow-[0_2px_8px_rgba(15,23,42,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[rgba(79,124,255,0.35)] hover:shadow-[0_6px_20px_rgba(15,23,42,0.10)] focus:outline-none focus:ring-4 focus:ring-[rgba(79,124,255,0.16)] dark:border-[#313c51] dark:bg-[#212d40] dark:text-[rgba(255,255,255,0.92)] dark:hover:border-[rgba(96,165,250,0.45)]"
                  >

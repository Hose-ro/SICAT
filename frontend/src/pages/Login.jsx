      ...
      <div className="relative mx-auto grid min-h-screen w-full max-w-7xl items-center gap-10 px-4 py-8 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:px-8">
        ...
        <section className="w-full">
          <div className="mx-auto max-w-xl lg:max-w-none">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-border bg-card/70 shadow-lg ">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="group relative">
                      <UserCircle className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary-ink" />
                      <input
                        id="identifier"
                        type="text"
                        ...
                        className="h-14 w-full rounded-2xl border border-input bg-background px-12 text-sm text-foreground outline-none transition-[color,background-color,border-color,opacity,transform] duration-200 placeholder:text-muted-foreground hover:border-primary/45 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="group relative">
                      <Lock className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary-ink" />
                      <input
                        id="password"
                        ...
                        required
                        placeholder="••••••••"
                        className="h-14 w-full rounded-2xl border border-input bg-background px-12 pr-12 text-sm text-foreground outline-none transition-[color,background-color,border-color,opacity,transform] duration-200 placeholder:text-muted-foreground hover:border-primary/45 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40"
                      />
                  ...
                  {registered && (
                    <div className="space-y-2 rounded-2xl border border-success/25 bg-success/10 px-4 py-3 text-sm text-success-foreground">
                      <p>
                        {!EMAIL_AUTH_ENABLED
